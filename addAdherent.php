<div id="addAdherent" style="margin-left:10% ;width:70%; ">
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="adh_seul" class="control-label col-xs-4">Rentre seul</label> 
    <div class="col-xs-8">
      <label class="radio-inline">
        <input type="radio" name="adh_seul" value="oui">
              Oui
      </label>
      <label class="radio-inline">
        <input type="radio" name="adh_seul" value="non">
              Non
      </label>
    </div>
  </div> 
  <div class="form-group row"   >
    ...
    <div id="submit" >
          <input style="display: inline-block;" type="submit"  class="btn btn-info" name="continue" value="Valider et ajouter nouveau" />
          <input style="display: inline-block; " type="submit"  class="btn btn-info" name="finish" value="Valider et finir" />
        </div>
    </div>
  </div>       
