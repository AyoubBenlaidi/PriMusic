...
<?php
	...
	$response = $bdd->query("UPDATE famille SET fml_name='".$_POST['nom']."', fml_mail='".$_POST['mail']."', fml_phone='".$_POST['telephone']."', fml_address='".$_POST['adresse']."', fml_commune='".$_POST['cmn_id']."', fml_zip='".$_POST['code_postal']."', fml_annee='".$annee[0][0]."' WHERE fml_id= '".$_POST['id']."'");
